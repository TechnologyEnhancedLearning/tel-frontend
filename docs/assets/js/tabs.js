...
const Tabs = function (container) {
  ...
  this.cssHide = 'tel-tabs__panel--hidden'
  this.tabs = container.querySelectorAll('.tel-tabs__tab')
  this.panels = container.querySelectorAll('.tel-tabs__panel')
...
Tabs.prototype.setupHtml = function () {
  this.container
    .querySelector('.tel-tabs__list')
    .setAttribute('role', 'tablist')
  this.container
    .querySelector('.tel-tabs__list-item')
...
document
  .querySelectorAll('[data-module="tel-tabs"]')
